        ...
        <div className="pt-24 px-4 mx-auto max-w-screen-xl">
            ...
            <div className="flex justify-between items-center bg-white p-6 rounded-lg shadow dark:bg-gray-800">
                ...
                <div className="space-x-4">
                    ...
                    <Link href="/checkout" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Proceed to Checkout
                    </Link>
                </div>
            </div>
